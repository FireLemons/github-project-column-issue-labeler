...
describe('Config', () => {
  ...
  describe('nonfatal invalid values', () => {
    ...
    describe ('projects', () => {
      ...
      describe('when a project has only whitespace for its owner login', () => {
